...
// The accepted contrast deviations: `#ffa726` on a light surface measures 1.94:1 and is a brand
// colour that does not change. Listed one by one rather than as `[data-a11y-exception]`, so a
// new marker has to be added here deliberately before it excuses anything.
