...
export const routes: Routes = [
  ...
  },
  {
    ...
    data: seo({
      ...
      description: $localize`:@@seo.apps-and-games.description:Alle Apps und Spiele von Boundfox Studios: LehrGrapht, MAT, Flugwacht, Flutter SDK Sync Companion und Bug-A-Ball — kostenlos, vieles davon Open Source.`,
    }),
  },
  {
    path: 'support',
